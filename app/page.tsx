...
export default function PosterPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // 2. Photo Layer - Math for Centered Fit
      const photoWidth = 366.95;
      const photoHeight = 448.47;
      const photoCenterX = 883.24;
      const photoCenterY = 709.45;

      // Calculate top-left based on center point
      ...
      // 3. Poster Overlay (The frame goes over the photo)
      ctx.drawImage(posterOverlay, 0, 0, canvas.width, canvas.height);

      // 4. Text Layer
      const textCenterX = 883.24;
      const textCenterY = 989.94;
              ...
              <div className="animate-in fade-in duration-500">
                ...
                <div className="relative w-full h-80 bg-slate-900 rounded-2xl overflow-hidden shadow-inner">
                  <Cropper
                    ...
                    crop={crop}
                    zoom={zoom}
                    aspect={366.95 / 448.47} // Matching your frame aspect ratio
